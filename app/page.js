...
const ProfileAIAnalysis = dynamic(() => import("./components/ProfileAIAnalysis"), {
    ssr: false,
    loading: () => (_jsx(Card, { children: _jsx(CardContent, { className: "py-12", children: _jsxs("div", { className: "flex flex-col items-center justify-center gap-4", children: [_jsx("div", { className: "w-8 h-8 border-4 border-indigo-500/30 border-t-indigo-500 rounded-full animate-spin" }), _jsx("p", { className: "text-gray-500 dark:text-gray-400 animate-pulse", children: "Loading analysis visualization..." })] }) }) })),
});
export default function HomePage() {
    ...
    const fetchGithubData = async (username, includePrivate = false) => {
        ...
        try {
            ...
            const payload = Object.assign(Object.assign({}, result), { fetchedWithAuth: includePrivate });
            setData(payload);
    ...
    const fetchProfileAnalysis = async (githubData) => {
        ...
        try {
            ...
            const result = await res.json();
            const updated = Object.assign(Object.assign({}, githubData), { analysis: result.analysis });
