...
export async function GET(request) {
    try {
        ...
        const scansWithStats = await Promise.all(scans.map(async (scan) => {
            ...
            if (scan.status === 'completed') {
                ...
                return {
                    id: scan.id,
                    repo_name: (repository === null || repository === void 0 ? void 0 : repository.name) || 'Unknown',
                    repo_full_name: (repository === null || repository === void 0 ? void 0 : repository.full_name) || 'unknown/unknown',
                    status: scan.status,
