...
export const metadata = {
  ...
  twitter: {
    ...
    title: "ClarityCode | AI GitHub Profile & Repository Analysis",
    description:
      "Analyze repositories and GitHub profiles with actionable AI insights.",
  },
  robots: {
    index: true,
    follow: true,
...
export default function RootLayout({ children }) {
  const gaMeasurementId =
    process.env.NEXT_PUBLIC_GA_MEASUREMENT_ID || "G-TS2NRZQF3M";
...
gtag('config', '${gaMeasurementId}');`,
      ...
      _jsxs("body", {
        ...
        children: [children, _jsx(Analytics, {}), _jsx(SpeedInsights, {})],
      }),
    ],
  });
}
